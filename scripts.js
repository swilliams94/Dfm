...
if(newsContainer){
    fetch("https://newsapi.org/v1/articles?source=bbc-news&apiKey=cb1134c841c64fd1b247f9eb0f74a5c7")
        .then(response => {
            return response.json();
        }).then(news => {
...
if(askJack){
    const askJackFormSubmit = e => {
        ...
        fetch(“https://swilliams94.github.io/Dfm/first.html", {mode: "no-cors", method: "POST", body: contact})
            .then(response => {
